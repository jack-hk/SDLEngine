...
void Run()
{
	...
	while (Game::_isRunning)
	{
		...
		Graphics::DrawCircle(Circle{ box1.GetBody().x, box1.GetBody().y, box1.GetBody().r }, Vector4D(255, 0, 0, 255));
		Graphics::DrawCircle(Circle{ box2.GetBody().x, box2.GetBody().y, box2.GetBody().r }, Vector4D(0, 0, 255, 255));
